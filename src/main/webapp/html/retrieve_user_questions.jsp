...
<html>
  ...
  <body id="main-area">
	...
	<section class="bg-dark text-white py-5" id="subscribe">
      <div class="container">
		...
		<div class="ml-3 col-md-2">
			<a href="post_question.jsp?redirect=/MainData/html/retrieve_user_questions.jsp" style="background-color:#fff;color:#333;" class="btn btn-c-btn btn-block">Add New ?</a>
		</div>
        </div>
      </div>
    </section>
			...
			<div class="card">
				...
				<div class="card">
					<div class="card-header" id="tag_ac">
						<h5 class="mb-0">
							<button class="btn btn-link" data-toggle="collapse" data-target="#tag_ac-body">
								Tag
							</button>
						</h5>
					</div>
			...
			<div class="card p-2 mb-3 "> 
				<div class="row no-gutters">
					...
					<div class="questions col-md-11">
						<a class="card-title h5 mb-4 d-block qh" href="question_answer.jsp"></a>
						<p class="tags" style="display: flex;justify-content: flex-start"></p>
						<p class="text-muted"> <i class="far fa-clock"></i><span id="time"></span> ago
							<i class="fas fa-eye"></i> <a id="views" > </a>
						</p>
					</div>
				</div>
			</div>
    ...
    <script src="../asset/plugin/navbar-fixed.js"></script>
    <script src="javascript/script.js"></script>
	<script src="HomePage/sort_uqstn.js"></script>			
  </body>
</html>